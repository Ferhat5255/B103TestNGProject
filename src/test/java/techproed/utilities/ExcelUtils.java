...
//   Constructor : Excel path i ve sayfaya ulasmak icin kullanilir
 ...
 //   Excel deki verileri Test sinifinda kullanmak icin bu metotu kullanacagiz
    ...
    //===============Exceldeki toplam surun sayisini return eder=================
    ...
    //==============Satır ve sütun numarasını girdiğinizde, o hucredeki veriyi return eder=========
    ...
    //============Excel deki datalari iki boyutlu array seklinde alir======================
...
//   Bu method ustteki metotla birlikte calisir, Overload eder. Parametreleri farklidir
    public void setCellData(String value, String columnName, int row) {
        int column = getColumnsNames().indexOf(columnName);
        setCellData(value, row, column);
    }

 //======exceldeki datalari basliksiz olarak iki boyutlu array seklinde return eder====================================
